module BusinessValidations
  ...
  included do
	...
	if: -> {self.current_step == :personal or self.current_step == :representative}
    ...
    if: -> {self.current_step == :financial or self.current_step == :representative}
    ...
    if: -> {(self.current_step == :financial or self.current_step == :representative) and self.is_tax_lien == true}
   ...
   # Step - Refinance
    ...
    if: -> {self.current_step == :refinance or (self.current_step == :representative and self.is_refinance)}
	...
	if: -> {self.current_step == :refinance or (self.current_step == :representative and self.is_refinance == "true")}
    ...
    if: -> {(self.current_step == :refinance or self.current_step == :refinance) and self.is_closing_fee == "true"}
