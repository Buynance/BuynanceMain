ActiveAdmin.register Offer do
  ...
  index do
    ...
    column("Customer", :sortable => :business_id) {|offer| BusinessUser.find_by(business_id: Business.find(offer.business_id, no_obfuscated_id: true).id).email if !Business.find(offer.business_id, no_obfuscated_id: true).nil?}
